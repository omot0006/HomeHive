...
function Landing() {
  ...
  return (
    ...
    <main className="bg-[#fff7ef] text-[#111827] overflow-hidden">
      ...
      <section className="min-h-screen bg-gradient-to-br from-[#07143d] to-[#10286d] pt-36 px-6 text-white text-center">
        ...
        >
          ...
          <p className="mt-8 max-w-2xl mx-auto text-xl text-white/75">
            ...
            Coordinate chores, manage shared expenses, and keep the peace.
            The operating system for modern households.
        ...
        <div className="h-full w-[80%] bg-[#ff9f1c] rounded-full">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            ...
            {features.map((feature,index)=>(
              ...
              >
                ...
                <div className="text-[#ff9f1c] mb-5">
        ...
        <div className="max-w-6xl mx-auto text-center">
            ...
            HOW IT WORKS
                ...
                <p className="text-gray-600 mt-5 max-w-xl mx-auto">
                    HomeHive makes shared living simple from the moment
      ...
      <section 
        id="landlords"
        className="py-28 px-6 bg-[#fff7ef]"
        >
        ...
        <div className="max-w-6xl mx-auto text-center">
            ...
            Whether you're sharing an apartment, running a family home,
            or managing properties — HomeHive adapts to your lifestyle.
            </p>
      ...
      <section className="bg-[#07143d] py-28 px-6 text-white">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <p className="mt-6 text-white/70 text-lg leading-relaxed">
                ...
                Turn your household into a connected community with
                AI-generated avatars, achievements, birthdays, and personalized profiles.
      ...
      <section className="py-28 px-6 bg-white">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <p className="mt-6 text-gray-600 max-w-2xl mx-auto">
                ...
                Replace forgotten chores, awkward money reminders,
                and messy group chats with a home everyone enjoys.
            ...
            {[
                ...
                {
                text:
                "We finally stopped using three different group chats just to manage our apartment."
                },


                {
                text:
                "Rent reminders are no longer awkward. Everyone knows what needs to happen."
                },


                {
                text:
                "Our house actually feels organized now. Everyone contributes fairly."
                }
                ...
                <p className="text-5xl text-[#ff9f1c]">
      ...
      {/* ================= FOOTER ================= */}
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div>
                ...
                Bringing roommates, families, and property owners
                together through smarter household management.
            ...
            <p>
                ...
                © 2026 HomeHive. All rights reserved.
            ...
            <p>
                ...
                Built to keep every home in sync 🐝
