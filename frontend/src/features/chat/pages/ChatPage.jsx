...
function ChatPage() {
  ...
  return (
    <main className="min-h-screen bg-hive-canvas p-4 sm:p-6 lg:p-8"><div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-7xl overflow-hidden rounded-[2rem] border border-hive-border bg-hive-surface shadow-hive-card lg:min-h-[calc(100vh-4rem)]">
